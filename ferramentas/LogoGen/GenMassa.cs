...
class P {
    public static string Pid, Cat, SI, Dom;
...
class Program {
    ...
    static void Main(){
        ...
        // ===== EXTRA (sugeridos) =====
        Add("Docker.DockerDesktop","Desenvolvimento","docker","");
        Add("Postman.Postman","Desenvolvimento","","getpostman.com");
        Add("Kong.Insomnia","Desenvolvimento","insomnia","");
        Add("DBeaver.DBeaverCommunity","Desenvolvimento","","dbeaver.io");
        Add("Ansgar.HeidiSQL","Desenvolvimento","","heidisql.com");
        Add("GitHub.cli","Desenvolvimento","github","");
        Add("Oven.Bun","Desenvolvimento","bun","");
        Add("DenoLand.Deno","Desenvolvimento","deno","");
        Add("HashiCorp.Terraform","Desenvolvimento","terraform","");
        Add("JetBrains.IntelliJIDEA.Community","Desenvolvimento","intellijidea","");
        Add("JetBrains.PyCharm.Community","Desenvolvimento","pycharm","");
        Add("JetBrains.Rider","Desenvolvimento","rider","");
        Add("Google.AndroidStudio","Desenvolvimento","android","");
        Add("Atlassian.Sourcetree","Desenvolvimento","","sourcetreeapp.com");
        Add("GitKraken.Fork","Desenvolvimento","","git-fork.com");
        Add("Microsoft.PowerShell.7","Desenvolvimento","powershell","");
        Add("Microsoft.WSL","Desenvolvimento","windowsterminal","");
        Add("Redis.RedisInsight","Desenvolvimento","redis","");
        Add("Oracle.MySQLWorkbench","Desenvolvimento","","mysql.com");
        Add("PostgreSQL.PostgreSQL","Desenvolvimento","postgresql","");
        Add("Microsoft.VisualStudio.2022.BuildTools","Desenvolvimento","visualstudio","");
        Add("Blizzard.BattleNet","Games","battlenet","");
        Add("Microsoft.XboxApp","Games","xbox","");
        Add("NordVPN.NordVPN","Pro Tools","nordvpn","");
        Add("Tailscale.Tailscale","Pro Tools","tailscale","");
        Add("Inkscape.Inkscape","Multimedia Tools","inkscape","");
        Add("Krita.Krita","Multimedia Tools","krita","");
        Add("Stremio.Stremio","Multimedia Tools","","stremio.com");
        Add("PeterPawlowski.foobar2000","Multimedia Tools","","foobar2000.org");
        Add("MusicBee.MusicBee","Multimedia Tools","","musicbee.io");
        Add("Notion.Notion","Utilities","notion","");
        Add("Joplin.Joplin","Utilities","joplin","");
        Add("Logseq.Logseq","Utilities","logseq","");
        Add("Greenshot.Greenshot","Utilities","greenshot","");
        Add("Flow-Launcher.Flow-Launcher","Utilities","","flowlauncher.app");
        Add("Mumble.Mumble","Utilities","mumble","");
        Add("BleachBit.BleachBit","Utilities","bleachbit","");
        Add("Piriform.CCleaner","Utilities","","ccleaner.com");
        Add("GlassWire.GlassWire","Utilities","glasswire","");
        Add("UderzoSoftware.SpaceSniffer","Utilities","","spacesniffer.net");
        Add("Listary.Listary","Utilities","","listary.com");
        Add("LaurentGomila.Keypirinha","Utilities","keypirinha","");
        Add("Toggl.TogglDesktop","Utilities","toggl","");
        Add("Gwidon.MersennePrime.Overseer","Pro Tools","","mersenne.org");
        Add("Geeks3D.FurMark","Pro Tools","","geeks3d.com");
        Add("GenuineSoftware.Speccy","Pro Tools","","ccleaner.com");
        Add("FinalWire.AIDA64.Extreme","Pro Tools","aida64","");
