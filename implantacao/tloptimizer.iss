...
AllowNoIcons=yes
LicenseFile=..\implantacao\assets\terms.txt
InfoBeforeFile=..\implantacao\assets\features.txt
OutputDir=..\build\installer
OutputBaseFilename=TLOptimizer-Setup-{#MyAppVersion}
SetupIconFile=..\implantacao\icon.ico
Compression=lzma2
SolidCompression=yes
WizardStyle=windows11 dark
WizardImageFile=..\implantacao\assets\wizard-side.bmp
WizardSmallImageFile=..\implantacao\assets\wizard-small.bmp
